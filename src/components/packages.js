...
class Packages extends Component {
    ...
    getPackages = (continent) => {
        axios.get('http://localhost:6600/package/destinations/' + continent)
            .then((response) => {
    ...
    getHotDeals = () => {
        axios.get("http://localhost:6600/package/hotDeals")
            .then((response) => {
                    ...
                    <div className="card bg-light text-dark package-card" key={mypackage.destinationId}>
                        <div className="card-body row">
                            <div className="col-md-4">
                                <img className="package-image" src={require("../assets/" + name)} alt="destination comes here" />
                            </div>
                            ...
                            <div className="row">
                                {this.state.deal ?
                                    <div className="col-md-6 text-center">
                                        <img className="package-image" src={require("../assets/" + this.state.deal.imageUrl.split("/")[2])} alt="destination comes here" />
                                    </div> : null}
